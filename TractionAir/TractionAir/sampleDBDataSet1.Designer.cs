...
namespace TractionAir.sampleDBDataSet1TableAdapters {
...
SELECT [Build Date], [TRT Code], [Pressure Group], [Board Code], Version, Owner, Description, [Vehicle Ref], [Speed Stages], [Step 1 kph], [Step 2 kph], [Step 3 kph], [Pressure Cell], [PT1 Code], [PT2 Code], [Distance (km)], [Date Mod], [Time Mod], Notes FROM ECUdata WHERE ([Board Code] = @Board_Code)";
        ...
        public virtual int Fill(sampleDBDataSet1.ECUdataDataTable dataTable) {
        ...
        public virtual sampleDBDataSet1.ECUdataDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            sampleDBDataSet1.ECUdataDataTable dataTable = new sampleDBDataSet1.ECUdataDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(sampleDBDataSet1.ECUdataDataTable dataTable) {
